export default function BulkTradesPage() {
  return (
    <div>
      <h2 className="text-xl font-bold mb-8 text-[#FFFEEF]">Order Management</h2>
      <div className="p-6 bg-[#1B1A14] border border-[#2A2620] rounded-[2px] min-h-[400px]">
        <div className="text-[10px] text-[#736A6C] uppercase tracking-[0.2em] mb-6 font-mono border-b border-[#2A2620] pb-2">Active Strategy Queue</div>
